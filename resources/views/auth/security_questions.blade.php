   ...
   <div class="flex items-center justify-center">
    <div class="max-w-xl w-full bg-white border border-slate-200 rounded-[40px] shadow-2xl overflow-hidden">
        ...
        <form action="#" method="POST" class="p-10 space-y-8">
            ...
            <div class="space-y-3"> <label for="pregunta1" class="block text-[11px] font-black text-[#233C7E] uppercase tracking-[0.2em] ml-1">
                    1. Segundo apellido del padre
                </label>
                <input type="text" name="pregunta1" id="pregunta1" required placeholder="Escriba su respuesta aquí" class="w-full px-6 py-4  border-2 border-slate-100 rounded-2xl text-slate-700 font-medium focus:outline-none focus:border-[#233C7E] focus:bg-white transition-all placeholder:text-slate-300">
            </div>

            <div class="space-y-3">
                <label for="pregunta2" class="block text-[11px] font-black text-[#233C7E] uppercase tracking-[0.2em] ml-1">
                    2. País que desea conocer
                </label>
                <input type="text" name="pregunta2" id="pregunta2" required placeholder="Escriba su respuesta aquí" class="w-full px-6 py-4  border-2 border-slate-100 rounded-2xl text-slate-700 font-medium focus:outline-none focus:border-[#233C7E] focus:bg-white transition-all placeholder:text-slate-300">
            </div>
