                ...
                <section class="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 rounded-2xl border border-slate-200">
                    ...
                    <div>
                        ...
                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                            ...
                            class="w-full rounded-xl border-slate-200 text-sm p-3 border text-slate-500 focus:ring-2 focus:ring-blue-500 outline-none @error('fecha_nacimiento') border-red-500 @enderror">
