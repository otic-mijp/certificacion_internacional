...
@section('content')
    <div class="bg-slate-50 flex items-center justify-center p-4">
        <div class="max-w-4xl w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200/60 overflow-hidden border border-slate-100">
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="lg:w-5/12 bg-slate-50 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-slate-100">
                    ...
                    <div class="space-y-3">
                        <h3 class="text-[10px] font-black text-[#233C7E] uppercase tracking-[0.2em] mb-4">
                            Requisitos mínimos
                        </h3>
                    ...
                    <form action="{{ route('usuario.clave.update') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            @error('current_password')
                                <p class="text-[10px] text-red-500 font-bold italic ml-1">{{ $message }}</p>
                            @enderror
                        </div>
