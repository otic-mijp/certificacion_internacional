...
<body>
    <div class=" flex items-center justify-center p-4">
        <div
            class="max-w-4xl w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200/60 overflow-hidden border border-slate-400">
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="lg:w-5/12  p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-slate-100">
                    ...
                    @if (session('status'))
                        <div
                            class="mb-6 p-4 bg-green-50 border border-green-200 text-green-700 text-xs font-bold rounded-2xl">
                            {{ session('status') }}
                        </div>
                    @endif

                    <div class="space-y-3">
                        <h3 class="text-[12px] font-black text-[#233C7E] uppercase tracking-[0.2em] mb-4">
                            Requisitos mínimos
                        </h3>
                        ...
                        <div id="req-length" class="flex items-start gap-3 group transition-opacity duration-300">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400 label-text transition-colors">8 a 15
                                    caracteres</p>
                            </div>
                        </div>
                        ...
                        <div id="req-special" class="flex items-start gap-3 group">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400 label-text transition-colors">Carácter
                                    especial</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:w-7/12 p-8 md:p-12 self-center">
                    <form action="{{ route('usuario.clave.obligatoria.update') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="password" name="current_password" id="current_password" 
                                    class="w-full px-5 py-4 bg-white border-2 @error('current_password') border-red-500 @else border-slate-300 @enderror rounded-2xl focus:border-[#233C7E] focus:ring-4 focus:ring-blue-500/10 outline-none transition-all pr-12 text-slate-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                <label
                                    class="block text-[12px] font-black text-[#233C7E] uppercase tracking-widest ml-1">
                                    Nueva clave:
                                </label>
                                <div class="relative">
                                    <input type="password" name="password" id="password" 
                                        class="w-full px-5 py-4 bg-white border-2 @error('password') border-red-500 @else border-slate-300 @enderror rounded-2xl focus:border-[#233C7E] focus:ring-4 focus:ring-blue-500/10 outline-none transition-all pr-12 text-slate-700">
                                    <button type="button" tabindex="-1"
                                        class="toggle-password-btn absolute inset-y-0 right-4 flex items-center text-slate-400 hover:text-[#233C7E]"
                            ...
                            <div class="space-y-2">
                                <label
                                    class="block text-[12px] font-black text-slate-400 uppercase tracking-widest ml-1">
                                    Confirmar Nueva:
                                </label>
                                <div class="relative">
                        ...
                        <div class="pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-4">
                            <a href="{{ route('usuario.perfil') }}"
                                class="flex items-center justify-center gap-2 px-8 py-4  hover:bg-slate-100 text-slate-500 text-[11px] font-bold uppercase tracking-[0.2em] rounded-xl border border-slate-200 transition-all active:scale-95">
                            ...
                            <button type="submit" id="submit-btn"
                                class="flex-1 py-5 bg-[#233C7E] text-white text-[11px] font-black uppercase tracking-[0.25em] rounded-2xl shadow-xl shadow-blue-900/20 transition-all active:scale-95">
                                Actualizar Ahora
                            </button>
                        </div>
                    </form>
    ...
    <div class="max-w-md mx-auto mt-10 p-6 bg-white border-l-4 border-amber-500 rounded-r-lg shadow-md">
        <div class="flex items-start">
            ...
            <div class="ml-4">
                ...
                <div class="mt-4">
                    <button type="button"
                        class="px-4 py-2 bg-amber-500 cursor-disabled text-white text-sm font-medium rounded transition-colors">
