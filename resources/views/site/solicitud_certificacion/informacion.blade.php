...
@section('content')
    <div class="max-w-3xl mx-auto px-4  font-sans antialiased text-gray-700">
        ...
        <div class="flex items-center gap-4  bg-slate-50">
            <div class="w-12 h-12 bg-[#233C7E] rounded-xl flex items-center justify-center text-white shadow-lg shadow-blue-900/20">
        ...
        <div class="p-8 md:p-12">
            <div class="group p-8 rounded-2xl border border-slate-200 bg-white hover:border-blue-100 hover:bg-blue-50/30 transition-all duration-300">
                <div class="flex flex-col md:flex-row md:items-center gap-6">
                    <div class="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-3xl shadow-sm  group-hover:scale-110 transition-transform duration-300 shrink-0">
                        📊
                    </div>
        ...
        <section id="apostilla" class="mb-12 scroll-mt-6">
            ...
            <div class="text-base md:text-lg leading-relaxed text-gray-600">
                <p class="mb-4 text-gray-700">
                    Si requiere que su documento tenga validez internacional, asegúrese de seguir estos pasos al realizar su solicitud:
                </p>
                <ul class="list-disc pl-5 space-y-3">
                    <li>
                        Seleccione <strong class="text-gray-950 font-semibold">SÍ</strong> en la opción <span class="italic font-medium text-gray-800">"¿Desea apostillar?"</span> para activar el proceso institucional.
                    </li>
                    <li>
                        Una vez procesada, la apostilla se enviará automáticamente a su correo electrónico en un plazo de <strong class="text-gray-950 font-semibold">XX días hábiles</strong>.
                    </li>
                </ul>
            </div>
        </section>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm md:text-base text-rose-800 leading-relaxed">
                            Si el sistema muestra este error al intentar generar el certificado, debe acudir presencialmente a la <strong class="font-semibold text-rose-950">Coordinación de Antecedentes Penales</strong> para gestionar su solicitud de manera directa.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-amber-50/60 border border-amber-200 rounded-xl p-5 md:p-6">
                <div class="flex items-start gap-3">
                    <svg class="w-6 h-6 text-amber-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 009 11a13.916 13.916 0 00-1.743-6.942m4.366 11.657c1.744-2.772 2.753-6.054 2.753-9.571s-1.009-6.799-2.753-9.571m0 19.142a15.921 15.921 0 003.44-2.04l.054-.09M12 11V3c1.933 0 3.5 1.567 3.5 3.5S13.933 10 12 11z" />
                    </svg>
                    <div>
                        ...
                        <p class="text-sm md:text-base text-amber-800 leading-relaxed mb-4">
                            Para tramitar el certificado de un menor de edad, el representative debe dirigirse a la <strong class="font-semibold text-amber-950">Coordinación de Antecedentes Penales</strong> presentando los siguientes requisitos:
                        </p>
                        ...
                        <p class="text-xs md:text-sm text-amber-700 italic border-t border-amber-200/60 pt-3 mt-2">
                            Nota: Si desconoce la ubicación exacta de esta oficina, puede asistir a la sede principal del MPPRIJP para recibir orientación y mayor información.
                        </p>
                    </div>
                </div>
            </div>
